    ...
    return (
      <div className="grid grid-cols-12 gap-6 max-w-[1600px] mx-auto">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-gray-900">Order Type</h3>
                    <p className="text-sm text-gray-500">Select the type of order</p>
                  </div>
                </div>
              </div>
              ...
              <Select value={orderType} onValueChange={(value) => {
                ...
                <SelectTrigger className="w-full bg-white border-2 h-12">
                  <SelectValue placeholder="Select Order Type" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="Montage" className="py-3 px-4">
                    <div className="flex items-center gap-3">
                      <div className="p-1.5 bg-blue-100 rounded-lg">
                        <Package className="h-4 w-4 text-blue-600" />
                      </div>
                      <div>
                        <p className="font-medium">Montage</p>
                        <p className="text-xs text-gray-500">Full lens mounting service</p>
                      </div>
                    </div>
                  </SelectItem>
                  <SelectItem value="Retoyage" className="py-3 px-4">
                    <div className="flex items-center gap-3">
                      <div className="p-1.5 bg-purple-100 rounded-lg">
                        <Settings className="h-4 w-4 text-purple-600" />
                      </div>
                      <div>
                        <p className="font-medium">Retoyage</p>
                        <p className="text-xs text-gray-500">Lens adjustment service</p>
                      </div>
                    </div>
                  </SelectItem>
                  <SelectItem value="Sell" className="py-3 px-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Direct product sale</p>
                      </div>
                    </div>
                  </SelectItem>
                  <SelectItem value="Unspecified" className="py-3 px-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Other type of order</p>
                      </div>
                    </div>
                  </SelectItem>
                </SelectContent>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Add and manage order items</p>
                  </div>
                </div>
                <div className="flex gap-2">
                  <Button onClick={() => addItem('product')} className="shadow-lg">
                    <Plus className="h-4 w-4 mr-2" /> Add Product
                  </Button>
                  <Button onClick={() => addItem('custom')} variant="outline" className="shadow">
              ...
              <div className="space-y-4">
                <ScrollArea className="h-[600px] pr-4">
                  <div className="space-y-4">
                    {items.map((item) => (
                      <Card key={item.id} className="overflow-hidden border border-gray-100 transition-all duration-200 hover:shadow-md">
                        <CardContent className="p-4">
                          <div className="flex flex-col gap-4">
                            <div className="flex items-start justify-between">
                              {item.customName !== undefined ? (
                                <div className="flex-1">
                                  <Label htmlFor={`custom-${item.id}`} className="text-sm font-medium text-gray-500">Custom Item Name</Label>
                                  <Input
                                    id={`custom-${item.id}`}
                                ...
                                <div className="flex-1">
                                  <Label htmlFor={`product-${item.id}`} className="text-sm font-medium text-gray-500">Product</Label>
                            ...
                            <div className="grid grid-cols-12 gap-4 items-end">
                              <div className="col-span-2">
                                <Label htmlFor={`quantity-${item.id}`} className="text-sm font-medium text-gray-500">Quantity</Label>
                                <Input
                                  id={`quantity-${item.id}`}
                                  type="number"
                                  min="1"
                              ...
                              <div className="col-span-2">
                                <Label htmlFor={`price-${item.id}`} className="text-sm font-medium text-gray-500">Price (DH)</Label>
                                <Input
                                  id={`price-${item.id}`}
                                  type="number"
                                  min="0"
                              ...
                              <div className="col-span-2">
                                <Label htmlFor={`cost-${item.id}`} className="text-sm font-medium text-gray-500">Cost (DH)</Label>
                                <Input
                                  id={`cost-${item.id}`}
                                  type="number"
                                  min="0"
                              ...
                              <div className="col-span-2">
                                ...
                                <div className="h-10 px-3 py-2 rounded-md bg-gray-50 font-medium flex items-center justify-end text-sm mt-1">
                              ...
                              <div className="col-span-2">
                                ...
                                <div className="h-10 px-3 py-2 rounded-md bg-green-50 text-green-700 font-medium flex items-center justify-end text-sm mt-1">
                                ...
                                <div className="col-span-2 flex items-center justify-end gap-2">
                                  <div className="flex gap-2 items-center">
                                    <Button
                                      ...
                                      size="icon"
                                      className={`h-10 w-10 rounded-xl ${item.linkedEye === 'LE' ? 'bg-primary text-white shadow-lg shadow-primary/20' : 'hover:bg-gray-100'}`}
                                      onClick={() => {
                                    ...
                                    <Button
                                      ...
                                      size="icon"
                                      className={`h-10 w-10 rounded-xl ${item.linkedEye === 'RE' ? 'bg-primary text-white shadow-lg shadow-primary/20' : 'hover:bg-gray-100'}`}
                                      onClick={() => {
                                        const updatedItem = { ...item };
        ...
        <div className="col-span-12 lg:col-span-4 space-y-6">
          <Card className="sticky top-6 overflow-hidden border-0 shadow-lg bg-gradient-to-br from-white to-gray-50">
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Financial details and calculations</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="discount" className="text-sm font-medium text-gray-500">Percentage Discount</Label>
                  ...
                  <div>
                    <Label htmlFor="numericDiscount" className="text-sm font-medium text-gray-500">Fixed Discount</Label>
                    <div className="relative mt-1">
                      <Input
                        id="numericDiscount"
                        type="number"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="tax" className="text-sm font-medium text-gray-500">Tax Base Amount</Label>
                    <div className="relative mt-1">
                      <Input
                        id="tax"
                        type="number"
                  ...
                  <div>
                    <Label htmlFor="taxIndicator" className="text-sm font-medium text-gray-500">Tax Rate</Label>
                    <div className="relative mt-1">
                      <Input
                        id="taxIndicator"
                        type="number"
                ...
                <div>
                  <Label htmlFor="advancePayment" className="text-sm font-medium text-gray-500">Advance Payment</Label>
                  <div className="relative mt-1">
                    <Input
                      id="advancePayment"
                      type="number"
                ...
                <div className="pt-2">
                  ...
                  <div className="mt-2 text-sm text-gray-600">
                    Balance Due: <span className="font-medium">{balance.toFixed(2)} DH</span>
                  </div>
                </div>
              </div>
            </CardContent>
