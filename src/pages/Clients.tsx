    ...
    <div className="container px-2 sm:px-4 md:px-6 max-w-7xl mx-auto py-4 sm:py-6 space-y-4 sm:space-y-6 min-w-[320px]">
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="bg-white rounded-lg p-4 shadow-sm border border-neutral-200/60">
              <div className="flex items-center gap-3 mb-4">
                <div className="h-10 w-10 rounded-full bg-teal-100/50 animate-pulse"></div>
                <div className="space-y-2 flex-1">
                  <div className="h-4 w-32 bg-teal-100/50 rounded animate-pulse"></div>
                  <div className="h-3 w-24 bg-teal-50/50 rounded animate-pulse"></div>
                </div>
              </div>
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-2">
                  <div className="h-8 bg-teal-50/50 rounded animate-pulse"></div>
                  <div className="h-8 bg-teal-50/50 rounded animate-pulse"></div>
                </div>
