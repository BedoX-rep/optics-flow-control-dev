...
const Financial = () => {
  ...
  const [openReceiptItemsAnalysis, setOpenReceiptItemsAnalysis] = React.useState(false)
  const [openDetailedExpenditureAnalysis, setOpenDetailedExpenditureAnalysis] = React.useState(false)
  ...
  return (
    <div className="container px-2 sm:px-4 md:px-6 max-w-[1600px] mx-auto py-4 sm:py-6 min-w-[320px]">
      ...
      <Collapsible open={openReceiptItemsAnalysis} onOpenChange={setOpenReceiptItemsAnalysis}>
        <Card className="mb-6">
          <CardHeader>
      ...
      {/* Detailed Expense Analysis - moved below the cards and redesigned */}
      ...
      {/* Collapsible Capital Expenditure and Operational Expenses Analysis */}
      <Collapsible open={openDetailedExpenditureAnalysis} onOpenChange={setOpenDetailedExpenditureAnalysis}>
        <Card className="mb-6">
          <CardHeader>
            <CollapsibleTrigger asChild>
              <Button variant="ghost" className="w-full justify-between">
