  ...
  const handleDeleteProduct = async () => {
    ...
    try {
      ...
      queryClient.setQueryData(['all-products', user.id], (oldData: Product[] | undefined) => {
        ...
        return oldData.filter(p => p.id !== productToDelete.id);
      });
      toast({
        title: "Success",
    ...
    <div className="w-full min-h-screen bg-slate-50/50 pb-20 overflow-x-hidden animate-in fade-in duration-700">
      ...
      <div className="w-full px-6 lg:px-10 relative z-20">
        ...
        <DeleteConfirmationDialog
          ...
          message={productToDelete ? (t('deleteConfirmationMessage')?.replace('{itemName}', productToDelete.name) || `Are you sure you want to delete "${productToDelete.name}"? This action cannot be undone.`) : ''}
