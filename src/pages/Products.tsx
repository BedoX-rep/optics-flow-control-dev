                      ...
                      <Select
                        ...
                        onValueChange={async (value) => {
                          try {
                            const { error } = await supabase
                              .from('products')
                              .update({ category: value === "none_selected" ? null : value })
                              .eq('id', product.id)
                              .eq('user_id', user.id);
                            
                            if (error) throw error;
                            setProducts(prev => prev.map(p => 
                              p.id === product.id ? { ...p, category: value === "none_selected" ? null : value } : p
                            ));
                          } catch (error) {
                            toast({
                              title: "Error",
                      ...
                      <Select
                        ...
                        onValueChange={async (value) => {
                          try {
                            const { error } = await supabase
                              .from('products')
                              .update({ index: value === "none_selected" ? null : value })
                              .eq('id', product.id)
                              .eq('user_id', user.id);
                            
                            if (error) throw error;
                            setProducts(prev => prev.map(p => 
                              p.id === product.id ? { ...p, index: value === "none_selected" ? null : value } : p
                            ));
                          } catch (error) {
                            toast({
                              title: "Error",
                      ...
                      <Select
                        ...
                        onValueChange={async (value) => {
                          try {
                            const { error } = await supabase
                              .from('products')
                              .update({ treatment: value === "none_selected" ? null : value })
                              .eq('id', product.id)
                              .eq('user_id', user.id);
                            
                            if (error) throw error;
                            setProducts(prev => prev.map(p => 
                              p.id === product.id ? { ...p, treatment: value === "none_selected" ? null : value } : p
                            ));
                          } catch (error) {
                            toast({
                              title: "Error",
                      ...
                      <Select
                        ...
                        onValueChange={async (value) => {
                          try {
                            const { error } = await supabase
                              .from('products')
                              .update({ company: value === "none_selected" ? null : value })
                              .eq('id', product.id)
                              .eq('user_id', user.id);
                            
                            if (error) throw error;
                            setProducts(prev => prev.map(p => 
                              p.id === product.id ? { ...p, company: value === "none_selected" ? null : value } : p
                            ));
                          } catch (error) {
                            toast({
                              title: "Error",
