          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-lg p-4 border border-teal-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-base font-medium text-teal-800">Basic Information</h3>
              </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-lg p-4 border border-teal-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-base font-medium text-teal-800">Eye Prescription</h3>
              </div>
              ...
              <div className="mt-4 pt-3 border-t border-teal-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel className="text-teal-700 font-medium text-sm">Store Prescription</FormLabel>
                        </div>
                      </FormItem>
                    )}
                  />
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-teal-700 font-medium text-sm">Optician Prescribed By</FormLabel>
                        <FormControl>
                          <Input 
                            {...field} 
                            type="text" 
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-lg p-4 border border-teal-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-base font-medium text-teal-800">Additional Information</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
                  control={form.control}
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-lg p-4 border border-teal-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-base font-medium text-teal-800">Renewal Information</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-teal-700 font-medium text-sm">Renewal Date</FormLabel>
                      <FormControl>
                        <Input 
                          {...field} 
                          type="date" 
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center space-x-3 space-y-0 mt-6">
                      ...
                      <div className="space-y-1 leading-none">
                        <FormLabel className="text-teal-700 font-medium text-sm">Need Renewal</FormLabel>
                      </div>
                    </FormItem>
                  )}
                />
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-teal-700 font-medium text-sm">Renewal Times</FormLabel>
                      <FormControl>
                        <Input 
                          {...field} 
                          type="number" 
