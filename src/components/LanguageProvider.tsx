...
const productTranslations: Translations = {
  ...
  // Missing ProductForm translations
  fillProductDetails: {
  ...
  autoGenerateProductName: {
    ...
    fr: 'Générer automatiquement le nom du produit basé sur les spécifications'
  },
  ...
  nameAutoGenerated: {
    ...
    fr: 'Le nom est généré automatiquement basé sur les spécifications'
  },
  imageUploadHint: {
