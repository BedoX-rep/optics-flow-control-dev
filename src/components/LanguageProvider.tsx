...
const financialTranslations: Translations = {
  ...
  // Additional missing translations for Financial page
  availableCash: {
    en: 'Available Cash',
    fr: 'Liquidités Disponibles'
  },
  ...
  detailedAnalysisAllSoldItems: {
    en: 'Detailed analysis of all sold items with filters',
    fr: 'Analyse détaillée de tous les articles vendus avec filtres'
  },
  includePaidAtDeliveryItems: {
    en: 'Include "Paid at Delivery" items',
    fr: 'Inclure les articles "Payés à la Livraison"'
  ...
  paidAtDeliveryItems: {
    en: 'paid at delivery items',
    fr: 'articles payés à la livraison'
  },
  categoryFilter: {
    en: 'Category Filter',
    fr: 'Filtre par Catégorie'
  ...
  comprehensiveBreakdownOfAllBusinessExpenses: {
    ...
    fr: 'Ventilation complète de toutes les dépenses d\'entreprise'
  },
  operationalExpenses: {
    en: 'Operational Expenses',
    fr: 'Dépenses Opérationnelles'
  ...
  totalProductCosts: {
    en: 'Total Product Costs',
    fr: 'Coûts Totaux des Produits'
  },
  ...
  paymentStatusFilter: {
    ...
    fr: 'Filtre par Statut de Paiement'
  },
  allPaymentStatus: {
