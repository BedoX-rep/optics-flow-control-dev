...
import { Sparkles, Plus, ShoppingBag, BarChart2, TrendingUp, CreditCard, Clock } from 'lucide-react';
...
const PurchasesHero = ({
    ...
    const stats = {
        ...
        totalAmount: purchases.reduce((sum, p) => sum + (p.amount_ttc || p.amount || 0), 0),
        monthlyAmount: purchases
            .filter(p => isCurrentMonth(p.purchase_date))
            .reduce((sum, p) => sum + (p.amount_ttc || p.amount || 0), 0),
                ...
                <div className="w-full relative z-10">
                    ...
                    >
                        <div className="flex flex-col md:flex-row md:items-center gap-8">
                            ...
                            <div className="flex flex-wrap items-center gap-8">
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-100/60 mb-1">{t('totalExpenses') || 'Total Expenses'}</span>
                                ...
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-rose-100/60 mb-1">{t('pendingPayments') || 'Pending Payments'}</span>
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            >
                                <Plus className="mr-3 h-5 w-5" /> {t('addSupplier') || 'Add Supplier'}
                            </Button>
                            ...
                            >
                                <Plus className="mr-3 h-5 w-5" /> {t('recordPurchase') || 'Record Purchase'}
                            </Button>
                        </div>
                    </motion.div>
                </div>
