...
const DashboardHero = ({ userName, onNewReceipt, onAddClient }: DashboardHeroProps) => {
    ...
    return (
        <div className="w-full bg-gradient-to-br from-teal-600 via-teal-500 to-indigo-600 text-white py-14 px-8 md:px-12 mb-10 shadow-2xl relative overflow-hidden rounded-b-[40px]">
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-4">
                        <Button
                            ...
                            className="bg-white/15 hover:bg-white/25 text-white border border-white/20 backdrop-blur-xl rounded-2xl px-8 h-14 font-bold transition-all hover:scale-105 active:scale-95 shadow-xl"
                        >
                            <Plus className="mr-3 h-5 w-5" /> {t('newReceipt')}
                        </Button>
                        <Button
                            onClick={onAddClient}
                            className="bg-teal-400 hover:bg-teal-300 text-teal-950 border-0 rounded-2xl px-8 h-14 font-black shadow-2xl shadow-teal-900/30 transition-all hover:scale-105 active:scale-95"
                        >
