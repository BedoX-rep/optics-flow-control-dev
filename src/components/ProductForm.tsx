  ...
  return (
    <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-white">
      ...
      <form className="space-y-6" onSubmit={onFormSubmit}>
        ...
        {/* Main Form Grid - 3 Column Card System */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Product Information Card */}
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="flex items-center gap-2 mb-4">
              <Package className="h-5 w-5 text-teal-600" />
              <h3 className="font-semibold text-gray-800">{t('productInformation')}</h3>
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-semibold text-gray-800">{t('pricingFinancial')}</h3>
            </div>
            <div className="space-y-4">
              {/* Price */}
              <div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-semibold text-gray-800">{t('inventoryMedia')}</h3>
            </div>
            <div className="space-y-4">
              {/* Stock Status */}
              <div>
